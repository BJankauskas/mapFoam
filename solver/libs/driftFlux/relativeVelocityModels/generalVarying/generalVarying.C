...
{
    defineTypeNameAndDebug(generalVarying, 0);
    addToRunTimeSelectionTable(relativeVelocityModel, generalVarying, dictionary);
}
}
...
Foam::relativeVelocityModels::generalVarying::generalVarying
(
...
void Foam::relativeVelocityModels::generalVarying::correct()
{
